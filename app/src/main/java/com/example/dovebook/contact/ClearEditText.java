...
public class ClearEditText extends android.support.v7.widget.AppCompatEditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    private OnClearEditTextChangeListener onClearEditTextChangeListener;
    ...
    public void setClearEditTextChangeListener(OnClearEditTextChangeListener onClearEditTextChangeListener){
        this.onClearEditTextChangeListener=onClearEditTextChangeListener;
    }
    public interface OnClearEditTextChangeListener{
        void onClearEditTextChange(String s);
    }
}
